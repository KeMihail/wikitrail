...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		hybrisImportData.setProductCatalogName(HYBRIS);
		hybrisImportData.setContentCatalogNames(Arrays.asList(HYBRIS));
		hybrisImportData.setStoreNames(Arrays.asList(HYBRIS));
